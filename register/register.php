            ...
            <div class="form-box login">
                ...
                <div id="formularioPrincipal">
                    <form action="php/procesar_registro.php" method="post">
                        ...
                        <input type="button" class="btn" id="btnContinuar" onclick="validarFormulario()" value="Continuar">
                        <input class="btn btn-black" id="btnMostrarForm" onclick="showForm()" value="Ya tengo una cuenta">
                </div>
